...
model = pickle.load(open(r'C:\Users\costa.0515\OneDrive - UNICRED DO BRASIL\Pos-Graduacao-Python\05-PGDC-Projeto Integrador\Projeto_Integrador\model\lgbm_credit_risk_model.pkl', 'rb'))
